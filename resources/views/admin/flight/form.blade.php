...
<section id="contact">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                @isset($status)
                <form action="{{route('status.update',$status->id)}}" method="POST" class="contact-form" enctype="multipart/form-data">
                @method('PUT')
                @else
                <form action="{{route('status.store')}}" method="POST" class="contact-form" enctype="multipart/form-data">
                @endisset
                    @csrf
