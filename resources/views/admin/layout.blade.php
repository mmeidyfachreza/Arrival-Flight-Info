      ...
      <div class="container"><a href="#" class="navbar-brand py-1"><img src="img/logo.png" alt="" class="img-fluid"></a>
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto px-3">
            <li class="nav-item active"><a href="{{url('/')}}" class="nav-link text-uppercase link-scroll">Beranda</a>
            </li>
            ...
            <li class="nav-item"><a href="{{route('maskapai.index')}}" class="nav-link text-uppercase link-scroll">Keluar</a>
            </li>
          </ul>
        </div>
      </div>
